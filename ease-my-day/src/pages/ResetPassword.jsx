      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F2F2F7] px-4 py-12 font-outfit">
        <div className="w-full max-w-md text-center">
          ...
          <div className="flex items-center justify-center space-x-2 mb-6">
            <div className="w-2 h-2 rounded-full bg-[#1C1C1E] animate-bounce"></div>
          ...
          <p className="text-sm text-[#9A9AA0]">Redirecting you to login...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md">
        ...
        {error && (
          <div className="mb-4 p-4 rounded-2xl bg-[#FF7A7A] bg-opacity-10 border-2 border-[#FF7A7A] text-[#111111] text-sm">
            {error}
            <div className="mt-2">
              <Link to="/forgot-password" className="text-[#1C1C1E] font-semibold underline">
