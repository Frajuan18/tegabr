...
export default function TimelinePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F7] font-outfit">
      ...
      <div className="lg:ml-80 pl-12 lg:pl-0 min-h-screen p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl m-auto">
          ...
          {/* View Toggle */}
          <div className="flex items-center gap-2 bg-white rounded-2xl p-1 mb-6 shadow-[0_4px_8px_rgba(0,0,0,0.05)] w-fit">
            <button
          ...
          <div className="bg-white rounded-3xl p-4 mb-6 shadow-[0_10px_0_#E5E5EA,0_12px_24px_rgba(0,0,0,0.1)]">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <h2 className="text-lg font-semibold text-[#111111]">{getDateHeader()}</h2>
                <button
                  onClick={handleToday}
                  className="px-4 py-1.5 text-sm bg-[#F2F2F7] text-[#6B6B70] rounded-xl hover:bg-[#E5E5EA] transition-colors"
                >
                  Today
                </button>
              </div>
          ...
          <div className="bg-white rounded-3xl p-12 shadow-[0_10px_0_#E5E5EA,0_12px_24px_rgba(0,0,0,0.1)]">
            <div className="text-center">
              <FaCalendarAlt className="h-16 w-16 text-[#E5E5EA] mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-[#111111] mb-2">No deadlines yet</h3>
